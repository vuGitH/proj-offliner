...
function getHeader(){ 
  ...
  var hPan = d.createElement('DIV');
      ...
      var hAHead = d.createElement('A');
          ...
          hAHead.style.textDecoration = "none";
              ...
              // favicon URL for LS( Localize ...)
                var favicUrl_LS = "" +
                    "https://plus.google.com/u/0/_/focus/photos/private/" +
                    "AIbEiAIAAABECI2J5OzY0_PsyAEiC3ZjYXJkX3Bob3RvKihlMjU0" +
                    "MzI1ZjI3MDk2MzYyN2RkNzZhYTdjZTY4MTdiZGI2YzE0MDFiMAE_" +
                    "L8kn-24AEcgLpF73-rdNABGVfw?sz=24";
             ...
             // hDivImg.style.display = 'inline';
              ...
              hPName.setAttribute('style',
                  'margin-top:12px;width:99%;background-color:#008888;' +
                  'box-shadow:0px 2px 8px #666,0px 3px 8px #2A403D;' +
                  'border-radius:9px;' +
                  'color:#fff;text-align:left;padding-top:3px;' +
      ...
      var hDivSrch = d.createElement('DIV');
          ...
          hDivSrch.setAttribute('style',
              'display:inline-block;float:right;position:relative;top:21px');
            ...
            var hFSearch = d.createElement('FORM');
                ...
                var srchBut = d.createElement('INPUT');
                    ...
                    srchBut.setAttribute('style',
                        'margin-left:4px;color:#fff;border:solid 1px #bb9cb3;' +
