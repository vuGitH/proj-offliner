...
function getHeader() {
    ...
    hStl.id = 'head_Stl' +
    parseInt(d.getElementsByTagName('STYLE').length - 1);
    var hStlStr = ".bold{font-weight:bold;}" +
                  ".red{color:#339cff;text-shadow:4px 4px 4px #ccc;}";
    ...
    hAHead.id = "hAHead";
     // link to site
    hAHead.setAttribute('href', 
        'https://sites.google.com/site/aquapowdersatinskin/');
    hAHead.style.textDecoration = "none";

    var hDivImg = d.createElement('DIV');
    hDivImg.id = 'hDivImg';
    hDivImg.setAttribute('class', 'hDivImg');
    // large picture with explanation
    var imgSrc = 
        "https://googledrive.com/host/" +
        "0B9mOESHtO2LXcC12ZnlpR0pQTzA/AquaPowderLifletEmail_v1.jpg"; 
    var lblSrc = "https://googledrive.com/host/" +
        "0B9mOESHtO2LXcC12ZnlpR0pQTzA/AquaPowderLable.jpg"; // lable
    ...
    //  look "http://stackoverflow.com/questions/10311092/" +
    ...
    hPName.setAttribute('style', 
        'margin-top:12px;width:99.5%;height:auto;background-color:#008888;' +
        'box-shadow:0px 2px 8px #666,0px 3px 8px #2A403D;border-radius:25px;' +
        'color:#fff;text-align:center;padding-top:3px;' +
        'padding-bottom:3px;padding-left:7px;' +
        'font-size:24px;font-weight:700;' +
        'text-shadow:0px 2px 2px #52241B,-6px 2px 21px #E6E5E5;' +
    ...
    hDivSrch.setAttribute('style', 'display:inline-block;' +
    ...
    inpSrch.setAttribute('style',
        'color:#008888;border:solid 1px #00a0a0;' +
    ...
    srchBut.setAttribute('style', 'margin-left:4px;' +
        'color:#fff;border:solid 1px #bb9cb3;' +
