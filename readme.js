 ...
 * this change may not be considered like something which destroys consistency * between package versions the major version number has not changed.
...
'npm install  - g proj-offliner\n'+
'\n'+
'To install for specified project go in project root directory and execute\n'+
'command:\n'+
